...
public class SearchExamservlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//create variable to save the values passed through jsp page to this controller class
		String ExamID =request.getParameter("eid");

		try {
			List<Exam> examDetails = ExamsDBUtil.searchexamDetails(ExamID);//create an object to call the methode created in dbutil
			...
			RequestDispatcher dis = request.getRequestDispatcher("SearchedDetails.jsp");
