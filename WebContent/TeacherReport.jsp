...
<body>
	...
	<div class="sidenav">
		...
		<a href="Search_for_update.jsp"><i class="fas fa-wrench" aria-hidden="true"></i><span>UpdateTeacher Info</span></a>
				...
				<tr>
					...
					<td>
						<div style="margin-left: 50px">
							<label for="assing">Status</label> <select name="Status">
	...
	<div id="reporttableBox">
		<h2 style="margin-left: 540px;">Teachers Report</h2>
		</centere>
		<center>
