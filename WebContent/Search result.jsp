				...
				<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						<c:forEach var="prog" items="${progdetails}">
							...
							<tr>
								<td style="background-color: #97DD5E; font-weight: bold">Teacher
									Remark</td>
						...
						<c:forEach var="stu" items="${details}">
							...
							<div class="form-control">
								<label style="color: teal; font-weight: 500;">Student
									ID:
									<h4 style="color: black; font-weight: 800;">${stu.studentID}</h4>
								</label>
							</div>
							<div class="form-control">
								<label style="color: teal; font-weight: 500">Student
									Name:
									<h4 style="color: black; font-weight: 800;">${stu.fullname}</h4>
								</label>
							</div>
