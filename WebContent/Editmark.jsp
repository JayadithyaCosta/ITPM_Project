...
<div class="container container-table">
  ...
  <div class="card-body">
    <form action="editResult"  method="post">
			...
			<label>Select subject:</label><select name="Subject" style="border: 1px solid gray; border-radius: 5px" required>
		...
		<div class="form-group col-md-6" style="margin-left: 215px">
			<label>Marks:</label><input type="text" name="mark" style="border: 1px solid gray; border-radius: 5px;" required><br>
		</div>	
			
			<button type="submit" name="edit" value="edit" class="btn btn-primary" style="width: 25%">Edit</button>
