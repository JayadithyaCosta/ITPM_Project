...
<body>
	...
	<div class="sidenav">
		...
		<div>
			<h4
				style="display: inline-block; align-items: center; color: #dfdfdf">
	...
	<div class="container container-table">
		<div class="row vertical-center-row">
			<div class="text-center col-lg-10 col-md-offset-4"
				style="left: 150px; height: 285px; margin-top: 150px; border-radius: 10px; width: 10rem">

				<div class="card-body">
					<div class="alert alert-success d-flex align-items-center"
						role="alert"
						style="height: 95px; margin-top: 64px; width: 60px; width: 29rem; margin-left: 190px; align-content: center;">
						<svg class="bi flex-shrink-0 me-2" width="24" height="24"
							role="img" aria-label="Success:">
							<use xlink:href="#check-circle-fill" /></svg>
						<div style="margin-left: 25px; font-size: 20px">Successful!
						</div>
					</div>
				</div>
			</div>
