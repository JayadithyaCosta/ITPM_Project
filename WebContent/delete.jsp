 ...
 <div class="card-body col text-center" style="border-radius: 10px">
					...
					<div class="table-responsive">
							<table class="table table-striped table-hover">
									...
									<tr>
										<th style="background-color:#4F8524">Subjects</th>
										<th style="background-color:#4F8524">Marks</th>
				...
				<c:forEach var="sub" items="${subdetails}">
								...
								<tr>
								<td style="background-color:#84e898">Updated Total</td>
								<td>${sum.total}</td>
								...
								<tr>
				                 ...
				                 <td style="background-color:#84e898">Updated Average</td>
				                 <td><fmt:formatNumber type="number" value="${Avg.avg}" pattern="0.000" maxFractionDigits="2"/> </td>
