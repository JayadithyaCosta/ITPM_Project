...
html2canvas: { scale: 2 },
jsPDF: { unit: 'mm', format: 'government-letter', orientation: 'landscape' }
};
...
<body>
  ...
  <center>
	<img src="css/logo.jpeg" class="user_type" alt="" style="margin-left: 180px;">
  </center>          
  <center><h2 style="margin-left: 50px;">Personal Teacher Report </h2></center>
  
            
  
<table style="margin-left: 10%;width:80%;padding-left: 10%" id="ReportTable">
