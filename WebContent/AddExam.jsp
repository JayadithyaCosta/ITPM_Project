		    					...
		    					<form action="AddExamservlet" method="post">
	    							...
	    							<h2>Add Exams </h2> <br>
	    								...
	    								<div class="input_field">
											...
											<input type="text" name="totalques"  placeholder="Total Question" required> <br><br>
											<input type="text" name="mark"  placeholder="Marks "required> <br><br>
											<input type="text" name="subid"  placeholder="Subject ID"required> <br><br>
											
										</div>
										
											<div class="btn1">
													<a href ="ListExamDetails.jsp"><input type="submit" name="save" value="Submit"></a>
											</div>
								</form>
    			</div>
